...
#ifndef _UDDIN_A_HW5_Q2_H_
#define _UDDIN_A_HW5_Q2_H_
...
public:
    ...
    btNode<Item>* getCurrent();
    const btNode<Item>* getCurrent()const;  
    btNode<Item>* getRoot();
    const btNode<Item>* getRoot() const; 
    void print();
...
#include "Uddin_A_HW5_Q2.cpp" // TODO
#endif 
